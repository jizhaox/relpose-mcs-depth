function generate_construct_coeff_v2()
...
syms rl_11 rl_12 rl_13 rl_21 rl_22 rl_23 rl_31 rl_32 rl_33 real
syms rr_11 rr_12 rr_13 rr_21 rr_22 rr_23 rr_31 rr_32 rr_33 real
...
R_left = [rl_11, rl_12, rl_13; rl_21, rl_22, rl_23; rl_31, rl_32, rl_33];
R_right = [rr_11, rr_12, rr_13; rr_21, rr_22, rr_23; rr_31, rr_32, rr_33];
R = R_left*[1-qy^2, 0, -2*qy; 0, 1+qy^2, 0; 2*qy, 0, 1-qy^2]*R_right;
...
% save
fid = fopen('construct_coeff_v2.m', 'wt');
for i = 1:3
    for j = 1:3
